        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            try
            {
                ...
                Customer regularUser = new Customer
                {
                    ...
                    ApplicationUser = regUser,
                };
                userManager.Create(regUser, "Password");
                context.SaveChanges();
                userManager.AddToRole(regUser.Id, customerRole);
                context.SaveChanges();
                ...
                {
                    even.Latitude = 43.869946 + (new Random()).NextDouble() / 10.0;
                    even.Longitude = 18.4182643 + (new Random()).NextDouble() / 10.0;
                    even.EventState = active;
